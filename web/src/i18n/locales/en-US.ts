const enUS = {
  ...
  skills: {
    ...
    requiresTools: 'Required Tools',
    requiresKbs: 'Required Knowledge Bases',
    requiresSkills: 'Required Sub-skills',
    author: 'Author',
    version: 'Version',
    tags: 'Tags',
    saveSuccess: 'Saved successfully',
    ...
    sandboxNetwork: 'Network Access',
    searchSkills: 'Search skills...',
    bindToPipeline: 'Bind to Pipeline',
    unbindFromPipeline: 'Unbind from Pipeline',
    pipelineSkills: 'Pipeline Skills',
    noPipelineSkills: 'No skills bound to this pipeline',
    addSkillToPipeline: 'Add Skill',
    selectSkills: 'Select Skills',
    priority: 'Priority',
    builtin: 'Built-in',
