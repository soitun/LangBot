const zhHans = {
  ...
  skills: {
    ...
    packageRootRequired: 'Package 根目录不能为空',
    noSkills: '暂未配置任何技能',
    enabled: '已启用',
    disabled: '已禁用',
    preview: '预览',
    ...
    sourceInline: '内联',
    sourcePackage: '本地包',
    packageRoot: 'Package 根目录',
    entryFile: '入口文件',
    skillTools: '技能工具',
    toolName: '工具名称',
    toolEntry: '脚本入口（如 scripts/run.py）',
    ...
    filterByType: '按类型筛选',
    searchSkills: '搜索技能...',
    bindToPipeline: '绑定到流水线',
    unbindFromPipeline: '从流水线解绑',
    pipelineSkills: '流水线技能',
    noPipelineSkills: '暂未绑定任何技能到此流水线',
    addSkillToPipeline: '添加技能',
    selectSkills: '选择技能',
    priority: '优先级',
    builtin: '内置',
  },
